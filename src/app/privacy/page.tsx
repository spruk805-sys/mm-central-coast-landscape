...
export const metadata = {
  title: "Privacy Policy | MM Central Coast Landscape",
  description:
    "Privacy Policy for MM Central Coast Landscape - how we collect, use, and protect your information.",
};
      ...
      <section className={`section-lg ${styles.contentSection}`}>
        <div className="container">
          <div className={styles.content}>
            <h2>Introduction</h2>
            <p>
              MM Central Coast Landscape, Inc. (&quot;we,&quot; &quot;our,&quot;
