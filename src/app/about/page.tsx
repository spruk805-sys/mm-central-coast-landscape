...
const team = [
  {
    ...
    bio: "Miguel founded MM Central Coast Landscape with a passion for transforming outdoor spaces. His expertise and dedication to quality have made the company a trusted name in the Santa Ynez Valley.",
  },
];
...
const milestones = [
  { year: "1995", event: "MM Central Coast Landscape founded in Solvang" },
          ...
          <div className={styles.storyGrid}>
            ...
            <div className={styles.storyContent}>
              ...
              <p className={styles.storyText}>
                MM Central Coast Landscape was founded in 1995 with a simple mission: 
