...
const services = [
  ...
  },
  {
    ...
    description: "Professional pruning, shaping, and complete tree removal for safety and beauty.",
  ...
  },
  {
    ...
    description: "Add structure and functionality to your landscape with professional hardscaping.",
    image: "/images/hardscape-service.png",
  },
  {
    icon: "🌱",
    title: "Sod Installation",
    description: "Get an instant lawn with our professional sod installation services.",
    image: "/images/sod-service.png",
  },
  {
    icon: "🗑️",
    title: "TrashCaddy Service",
    description: "We'll bring your bins to the curb and return them after collection.",
...
const testimonials = [
  {
    quote: "MM Central Coast Landscaping transformed our backyard into an oasis. Their attention to detail is unmatched!",
    author: "Sarah M.",
    location: "Solvang, CA",
  },
  {
        ...
        <div className={`container ${styles.heroContent}`}>
          <div className={styles.heroMain}>
            ...
            <div className={styles.heroActions}>
              ...
              <Link href="/dump-quote" className="btn btn-secondary btn-lg" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '2px', padding: '12px 32px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  <span style={{ fontSize: '1.2rem', fontWeight: 'bold' }}>Junk Removal Quote</span>
                  <span style={{ fontSize: '1.2rem' }}>🚛</span>
                </div>
                <span style={{ fontSize: '0.8rem', opacity: 0.9, fontWeight: 'normal' }}> 📸 Photo-AI Estimation</span>
              </Link>
            </div>
